...
if(!$session->logged_in  || ($session->userlevel != 9) || $_SERVER['HTTP_REFERER']!=SECURE_PATH.'home/')
{
	...
	<div class="" id="adminTable1">
		...
		<script>
			setState('adminTable1','<?php echo SECURE_PATH; ?>view_project_new/process.php','tableDisplayy=1');
		</script>
	</div>
	...
	<div class="" id="adminTable">
		...
		<script>
			setState('adminTable','<?php echo SECURE_PATH; ?>view_project_new/process.php','tableDisplay=1');
		</script>
	</div>
